...
class Icdar15Text_mid(TextDataset):
    ...
    def __init__(self, data_root, is_training=True, load_memory=False, transform=None, ignore_list=None):
        ...
        self.image_root = os.path.join(data_root, 'train/img' if is_training else 'test/img')   #me
        self.annotation_root = os.path.join(data_root,'train/gt' if is_training else 'test/gt') #me
        ...
        print("me add in dataset/Icdar15_Text.py",self.annotation_list) #me
        print("me add in dataset/Icdar15_Text.py, total training images: ",len(self.annotation_list)) #me
    ...
    def load_img_gt(self, item):
        ...
        #print("me add, in dataset/Icdar15_Text.py, images path is: {}".format(image_path))
        try:
            # Read annotation
            annotation_id = self.annotation_list[item]
            annotation_path = os.path.join(self.annotation_root, "gt_"+annotation_id) #me
            polygons = self.parse_txt(annotation_path)
            #print("me add, in dataset/Icdar15_Text.py, annotation_path is: {}, polygons is: {}".format(annotation_path, polygons))
